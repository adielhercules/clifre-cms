...
import { capitalize, clamp } from '../../utils/text'
...
class Slider extends Component {
  ...
  render () {
    const { value, orientation, className, fillClassName, handleClassName } = this.props
    ...
    return (
      ...
      >
        <div
          className={cx('rangeslider__fill', fillClassName)}
          style={fillStyle}
        />
        <div
          ref={(sh) => { this.handle = sh }}
          className={cx('rangeslider__handle', handleClassName)}
